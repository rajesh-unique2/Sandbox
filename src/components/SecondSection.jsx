...
const SecondSection = () => {
  ...
  return (
    ...
    <div className="w-screen h-screen box-border flex justify-center items-start flex-col p-2 lg:p-5 bg-gray-50 lg:my-40 md:my-3 sm:my-5">
      ...
      <div className="w-full h-40 grid lg:grid-cols-3 grid-cols-[1fr] m-0 sm:place-items-center lg:mt-20 gap-8">
        {
            usage.map((data)=>{
                return(
                    <div className="lg:w-100 sm:w-150 md:w-full md:px-14 h-auto p-2 flex sm:gap-5 flex-row opacity-100 text-black sm:hover:cursor-pointer sm:hover:shadow-2xl sm:hover:duration-300 sm:rounded-2xl hover:cursor-pointer hover:duration-300 hover:shadow-2xl" key={data.id} onClick={changePage(data.id)}>
